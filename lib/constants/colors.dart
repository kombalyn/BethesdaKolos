...
class AppColors {
  static const Color whitewhite = Color(0xFFFFFFFF); // Fully opaque white
  static const Color bethesdacolor = Color(0xFFE41B48); // Bethesda pinkje
  static const Color lightaccentcolor = Color(0xFFE3968D); // Halvány rózsaszínes
  ...
  static const Color greenish = Color(0xFF7CB518);
  static const Color blue = Color(0xFF5998C5);
