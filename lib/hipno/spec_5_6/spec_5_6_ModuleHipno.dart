...
import 'spec_5_6_ModuleHipno_page2.dart';

import '../ModuleHipno.dart';
export '../../home_page_model.dart';
import '../../appbar/appbar.dart';

class spec_5_6_ModuleHipno extends StatelessWidget {
  String Azonosito = '';

  spec_5_6_ModuleHipno(String s, {super.key}) {
    Azonosito = s;
  }
...
class spec_5_6_ModuleHipnoWidget extends StatefulWidget {
  spec_5_6_ModuleHipnoWidget(String azonosito, {super.key}) {
    Azonosito = azonosito;
  }
  String Azonosito = '';
...
class _spec_5_6_ModuleHipnotState extends State<spec_5_6_ModuleHipnoWidget> {
  ...
  String Azonosito = '';
  _spec_5_6_ModuleHipnotState(String azonosito) {
    Azonosito = azonosito;
  }
