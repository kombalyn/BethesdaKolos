...
import 'spec_5_6_ModuleHipno.dart';
...
class spec_5_6_ModuleHipno2 extends StatelessWidget {
  spec_5_6_ModuleHipno2(String s, {super.key}){Azonosito=s;}
  String Azonosito = '';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home:  spec_5_6_ModuleHipnoWidget(Azonosito),
    );
  }
}


class spec_5_6_ModuleHipnoWidget extends StatefulWidget {
  spec_5_6_ModuleHipnoWidget(String azonosito, {super.key}){Azonosito=azonosito;}
  String Azonosito = '';

  @override
  State<spec_5_6_ModuleHipnoWidget> createState() => _spec_5_6_ModuleHipnotState(Azonosito);
}

class _spec_5_6_ModuleHipnotState extends State<spec_5_6_ModuleHipnoWidget> {
  ...
  late Uri _url;
  _spec_5_6_ModuleHipnotState(String azonosito){Azonosito=azonosito;}
      ...
      child: Scaffold(
        ...
        drawer: Drawer(
          child:  SidebarLayout(
            ...
            weekScreens: {
              '1-2.hét': {
                'screenBuilder': (context) => spec_5_6_ModuleHipno('Azonsito'),
                'isClickable': true,
              },
              '3-4.hét': {
                        ...
                        Center(
                          child: Container(
                            ...
                            child: SizedBox(
                              ...
                              child:  AudioPlayerPage(url: "https://storage.googleapis.com/lomeeibucket/Progr_relax_nagyoknak.mp3",azonosito: "$Azonosito",hangfajlszam: "mp3_3",onUzenetKuldes: szamokBbeallitas,),
