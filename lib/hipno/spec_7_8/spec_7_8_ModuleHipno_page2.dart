...
class spec_7_8_ModuleHipno2 extends StatelessWidget {
  spec_7_8_ModuleHipno2(String s, {super.key}){Azonosito=s;}
  String Azonosito = '';
...
class spec_7_8_ModuleHipnoWidget extends StatefulWidget {
  spec_7_8_ModuleHipnoWidget(String azonosito, {super.key}){Azonosito=azonosito;}
  String Azonosito = '';
...
class _spec_7_8_ModuleHipnotState extends State<spec_7_8_ModuleHipnoWidget> {
  ...
  late Uri _url;
  _spec_7_8_ModuleHipnotState(String azonosito){Azonosito=azonosito;}
      ...
      child: Scaffold(
        ...
        drawer: Drawer(
          child:  SidebarLayout(
            ...
            weekScreens: {
              '1-2.hét': {
                'screenBuilder': (context) => spec_7_8_ModuleHipno('Azonsito'),
                'isClickable': true,
              },
              '3-4.hét': {
