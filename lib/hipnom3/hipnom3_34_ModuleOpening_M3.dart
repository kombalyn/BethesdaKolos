...
class hipnom3_ModuleOpening_M3 extends StatelessWidget {
  String Azonosito = '';
  hipnom3_ModuleOpening_M3(String s, int i, {super.key}) {
    Azonosito = s;
  }
      ...
      MultiProvider(
        ...
        child: MaterialApp(
          ...
          routes: {
            ...
            '/module_opening': (context) => hipnom3_ModuleOpening_M3_Widget(Azonosito),
            // Adding the existing module screen as a route
          },
          home: hipnom3_ModuleOpening_M3_Widget(Azonosito), // Default home screen
        ),
      );
  }
}

class hipnom3_ModuleOpening_M3_Widget extends StatefulWidget {
  final String Azonosito;

  hipnom3_ModuleOpening_M3_Widget(this.Azonosito, {Key? key}) : super(key: key);

  @override
  _hipnom3_ModuleOpening_M3_WidgetState createState() =>
      _hipnom3_ModuleOpening_M3_WidgetState();
}

class _hipnom3_ModuleOpening_M3_WidgetState extends State<hipnom3_ModuleOpening_M3_Widget> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar:   CustomAppBar(title: 'Kutatási fázis',  backgroundColor: AppColors.greenish, // Optional: Override the default background color
        iconColor: AppColors.greenish,),      body: SingleChildScrollView(
                                  ...
                                  Container(
                                    ...
                                    child: ListTile(
                                      ...
                                      title: Text(
                                        'Kérdések',
                                        style:
                                        MyTextStyles.vastaggreen(context),
                                      ),
                                      onTap: () async {
                                      ...
                                      Row(
                                        children: [
                                          Expanded(
                                            child: Text(
                                              "Szia!",
                                              style: MyTextStyles.huszonkettovastaggreen(context),
                                            ),
                                          ),
                                        ],
                                      ),
