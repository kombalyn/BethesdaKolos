...
class M3_4het extends StatefulWidget {
  const M3_4het({super.key});

  @override
  _M3_4het createState() => _M3_4het();
}

class _M3_4het extends State<M3_4het> {
        ...
        child: ListTile(
          ...
          onTap: () {
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(
                builder: (BuildContext context) => const M3_4het(),
              ),
            );
          },
        ),
