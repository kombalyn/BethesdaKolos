...
class QuizScreen6 extends StatefulWidget {
  static const routeName = '/quiz6';

  const QuizScreen6({super.key});

  @override
  _QuizScreenState6 createState() => _QuizScreenState6();
}
...
// Ensure to define this method in your class
  void _navigateToNextQuestion(int nextQuestionIndex) {
    final quizProvider = Provider.of<QuizProvider6>(context, listen: false);
...
// Method to scroll back to top of the screen
  ...
  Widget build(BuildContext context) {
    ...
    double progressValue = (quizProvider.currentQuestion.index + 1) / 8;
