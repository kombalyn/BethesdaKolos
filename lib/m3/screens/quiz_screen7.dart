...
class QuizScreen7 extends StatefulWidget {
  static const routeName = '/quiz7';

  const QuizScreen7({super.key});

  @override
  _QuizScreenState7 createState() => _QuizScreenState7();
}
...
class _QuizScreenState7 extends State<QuizScreen7> {
  ...
  //   return [];
  // }
  // Method to build checkboxes for a question with styling similar to radio options
  // Method to build checkboxes for a question with consistent styling
  // Method to build checkboxes for a question with consistent styling
  // Method to build 'nooption' handling
...
// Ensure to define this method in your class
  void _navigateToNextQuestion(int nextQuestionIndex) {
    final quizProvider = Provider.of<QuizProvider7>(context, listen: false);
          ...
          child: GradientButton(
            ...
            onPressed: () async {
              if (question.userResponse == null || question.userResponse!.isEmpty) {
                ...
                final quizProvider = Provider.of<QuizProvider5>(context, listen: false);
                ...
                if (quizProvider.isQuizFinished) {
                  ...
                  Navigator.of(context).pushReplacement(
                    MaterialPageRoute(
                      builder: (context) => ModuleOpening_M3('Azonosito',0),
                    ),
                  );
                }
              }
...
// Method to scroll back to top of the screen
  ...
  Widget build(BuildContext context) {
    final quizProvider = Provider.of<QuizProvider5>(context, listen: true);

    final currentQuestion = quizProvider.currentQuestion;
    double progressValue = (quizProvider.currentQuestion.index + 1) / 9;
                    ...
                    Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          if (currentQuestion.nooption ?? false) _buildNoOption(currentQuestion),
                          ...
                          ] else if (currentQuestion.requiresCheckOptions)
                        
                    _buildCheckBoxOptions(currentQuestion)
