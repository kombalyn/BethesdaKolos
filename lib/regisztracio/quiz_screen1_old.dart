...
class _QuizScreenState1 extends State<QuizScreen1> {
  ...
  List<String> _savedAnswersFor24 = []; // Új változó a 22-es válaszok tárolására
                                ...
                                if (_optionControllers.isNotEmpty &&
                                  ...
                                  GradientButton(
                                    ...
                                    onPressed: () async {
                                      ...
                                      for (int ix = 0;
                                          ix < _rankableOptions.length;
                                          ix++) {
                                        if (_optionController52[ix]
                                                .text
                                                .isEmpty &&
                                            quizProvider1
                                          ...
                                          return;
                                        } else if (_optionController52[ix]
                                                .text
                                                .isNotEmpty &&
                                            quizProvider1
                                                    .currentQuestion.index ==
                                                19) {
                                          values.add(
                                              '${oldValues[ix]}%%${_optionController52[ix].text}');
                                        }
                                      }

                                      /* ADAM KISZEDTE es betette a kötzvetlen alatta levot
                                      if (quizProvider1.currentQuestion.index ==
                                          19) {
                                       ...
                                       */
                                      // Mentés mindenképpen, függetlenül a kérdés indexétől
                                      currentQuestion.userResponse = values;
                                      saveAsnwere(currentQuestion);


                                      _sendAnswer(
                                          quizProvider1.currentQuestion.index,
                                          _rankableOptions.join(', '),
                                          currentQuestion.text);
                                      ...
                                      setState(() {
                                        List<String> answers =
                                            _optionControllers
                                                ...
                                                .toList();
                                        // print(
                                        //     'Here we got answeere ${answers.toSet()}');
                                        ...
                                        if (answers.length >= 5 &&
                                          ...
                                          ScaffoldMessenger.of(context)
                                              .showSnackBar(const SnackBar(
                                            content: Text(
                                                'Kérlek, adj meg legalább 5 különböző választ.'),
                                          ));
                                        }
                                      });
                                    },
                                  ...
                                  children: [
                                    ...
                                    GradientButton(
                                      ...
                                      onPressed: () async {
                                        ...
                                        // quizProvider1.nextQuestion();
                                        print(
                                            'finish ${quizProvider1.isQuizFinished}');
