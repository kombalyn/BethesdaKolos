...
class ModuleStandard_10het extends StatelessWidget {
  String Azonosito = '';
  ModuleStandard_10het(String s, {super.key}){Azonosito=s;}
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home:  ModuleStandard_10het_widget(Azonosito),
    );
  }
}

class ModuleStandard_10het_widget extends StatefulWidget {
  String Azonosito = '';
  ModuleStandard_10het_widget(String azonosito, {super.key}){Azonosito=azonosito;}

  @override
  State<ModuleStandard_10het_widget> createState() => _ModuleStandard_10het_widget(Azonosito);
}

class _ModuleStandard_10het_widget extends State<ModuleStandard_10het_widget> {
  ...
  String Azonosito = '';
  _ModuleStandard_10het_widget(String azonosito){Azonosito=azonosito;}
    ...
    return Scaffold(
      ...
      drawer: Drawer(
        ...
        SidebarLayout(
          ...
          selectedWeek: '10.hét', // Specify which week is selected
          weekTextStyles: {
            '10.hét': MyTextStyles.vastagblue(context),  // Style for '1.hét'
