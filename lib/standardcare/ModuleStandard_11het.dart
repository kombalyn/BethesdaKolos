...
class ModuleStandard_11het extends StatelessWidget {
  String Azonosito = '';
  ModuleStandard_11het(String s, {super.key}){Azonosito=s;}
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home:  ModuleStandard_11het_widget(Azonosito),
    );
  }
}

class ModuleStandard_11het_widget extends StatefulWidget {
  String Azonosito = '';
  ModuleStandard_11het_widget(String azonosito, {super.key}){Azonosito=azonosito;}

  @override
  State<ModuleStandard_11het_widget> createState() => _ModuleStandard_11het_widget(Azonosito);
}

class _ModuleStandard_11het_widget extends State<ModuleStandard_11het_widget> {
  ...
  String Azonosito = '';
  _ModuleStandard_11het_widget(String azonosito){Azonosito=azonosito;}
    ...
    return Scaffold(
      ...
      drawer: Drawer(
        child:    SidebarLayout(
          ...
          selectedWeek: '11.hét', // Specify which week is selected
          weekTextStyles: {
            '11.hét': MyTextStyles.vastagblue(context),  // Style for '1.hét'
