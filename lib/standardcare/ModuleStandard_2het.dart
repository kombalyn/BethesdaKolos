...
class ModuleStandard_2het extends StatelessWidget {
  String Azonosito = '';
  ModuleStandard_2het(String s, {super.key}){Azonosito=s;}
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home:  ModuleStandard_2het_widget(Azonosito),
    );
  }
}

class ModuleStandard_2het_widget extends StatefulWidget {
  String Azonosito = '';
  ModuleStandard_2het_widget(String azonosito, {super.key}){Azonosito=azonosito;}

  @override
  State<ModuleStandard_2het_widget> createState() => _ModuleStandard_2het_widget(Azonosito);
}

class _ModuleStandard_2het_widget extends State<ModuleStandard_2het_widget> {
  ...
  String Azonosito = '';
  _ModuleStandard_2het_widget(String azonosito){Azonosito=azonosito;}
      ...
      drawer: Drawer(
        child:  SidebarLayout(
          ...
          weekScreens: {
            ...
            // Add more weeks...
          },                selectedWeek: '2.hét', // Specify which week is selected
          weekTextStyles: {
            '2.hét': MyTextStyles.vastagblue(context),  // Style for '1.hét'
