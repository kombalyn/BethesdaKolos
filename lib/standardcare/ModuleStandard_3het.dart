...
class ModuleStandard_3het extends StatelessWidget {
  String Azonosito = '';
  ModuleStandard_3het(String s, {super.key}){Azonosito=s;}
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home:  ModuleStandard_3het_widget(Azonosito),
    );
  }
}

class ModuleStandard_3het_widget extends StatefulWidget {
  String Azonosito = '';
  ModuleStandard_3het_widget(String azonosito, {super.key}){Azonosito=azonosito;}

  @override
  State<ModuleStandard_3het_widget> createState() => _ModuleStandard_3het_widget(Azonosito);
}

class _ModuleStandard_3het_widget extends State<ModuleStandard_3het_widget> {
  ...
  String Azonosito = '';
  _ModuleStandard_3het_widget(String azonosito){Azonosito=azonosito;}
      ...
      drawer: Drawer(
        child:   SidebarLayout(
          ...
          weekScreens: {
            ...
            // Add more weeks...
          },                selectedWeek: '3.hét', // Specify which week is selected
          weekTextStyles: {
            '3.hét': MyTextStyles.vastagblue(context),  // Style for '1.hét'
