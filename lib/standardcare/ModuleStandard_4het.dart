...
class ModuleStandard_4het extends StatelessWidget {
  String Azonosito = '';
  ModuleStandard_4het(String s, {super.key}){Azonosito=s;}
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home:  ModuleStandard_4het_widget(Azonosito),
    );
  }
}

class ModuleStandard_4het_widget extends StatefulWidget {
  String Azonosito = '';
  ModuleStandard_4het_widget(String azonosito, {super.key}){Azonosito=azonosito;}

  @override
  State<ModuleStandard_4het_widget> createState() => _ModuleStandard_4het_widget(Azonosito);
}

class _ModuleStandard_4het_widget extends State<ModuleStandard_4het_widget> {
  ...
  String Azonosito = '';
  _ModuleStandard_4het_widget(String azonosito){Azonosito=azonosito;}
    ...
    return Scaffold(
      ...
      drawer: Drawer(
        child: SidebarLayout(
          ...
          },                selectedWeek: '4.hét', // Specify which week is selected
          weekTextStyles: {
            '4.hét': MyTextStyles.vastagblue(context),  // Style for '1.hét'
