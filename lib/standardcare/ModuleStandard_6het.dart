...
class ModuleStandard_6het extends StatelessWidget {
  String Azonosito = '';
  ModuleStandard_6het(String s, {super.key}){Azonosito=s;}
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home:  ModuleStandard_6het_widget(Azonosito),
    );
  }
}

class ModuleStandard_6het_widget extends StatefulWidget {
  String Azonosito = '';
  ModuleStandard_6het_widget(String azonosito, {super.key}){Azonosito=azonosito;}

  @override
  State<ModuleStandard_6het_widget> createState() => _ModuleStandard_6het_widget(Azonosito);
}

class _ModuleStandard_6het_widget extends State<ModuleStandard_6het_widget> {
  ...
  String Azonosito = '';
  _ModuleStandard_6het_widget(String azonosito){Azonosito=azonosito;}
    ...
    return Scaffold(
      ...
      drawer: Drawer(
        child:  SidebarLayout(
          ...
          },                selectedWeek: '6.hét', // Specify which week is selected
          weekTextStyles: {
            '6.hét': MyTextStyles.vastagblue(context),  // Style for '1.hét'
