...
class ModuleStandard_7het extends StatelessWidget {
  String Azonosito = '';
  ModuleStandard_7het(String s, {super.key}){Azonosito=s;}
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home:  ModuleStandard_7het_widget(Azonosito),
    );
  }
}

class ModuleStandard_7het_widget extends StatefulWidget {
  String Azonosito = '';
  ModuleStandard_7het_widget(String azonosito, {super.key}){Azonosito=azonosito;}

  @override
  State<ModuleStandard_7het_widget> createState() => _ModuleStandard_7het_widget(Azonosito);
}

class _ModuleStandard_7het_widget extends State<ModuleStandard_7het_widget> {
  ...
  String Azonosito = '';
  _ModuleStandard_7het_widget(String azonosito){Azonosito=azonosito;}
    ...
    return Scaffold(
      ...
      drawer: Drawer(
        child:SidebarLayout(
          ...
          selectedWeek: '7.hét', // Specify which week is selected
          weekTextStyles: {
            '7.hét': MyTextStyles.vastagblue(context),  // Style for '1.hét'
