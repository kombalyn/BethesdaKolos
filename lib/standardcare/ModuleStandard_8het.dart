...
class ModuleStandard_8het extends StatelessWidget {
  String Azonosito = '';
  ModuleStandard_8het(String s, {super.key}){Azonosito=s;}
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home:  ModuleStandard_8het_widget(Azonosito),
    );
  }
}

class ModuleStandard_8het_widget extends StatefulWidget {
  String Azonosito = '';
  ModuleStandard_8het_widget(String azonosito, {super.key}){Azonosito=azonosito;}

  @override
  State<ModuleStandard_8het_widget> createState() => _ModuleStandard_8het_widget(Azonosito);
}

class _ModuleStandard_8het_widget extends State<ModuleStandard_8het_widget> {
  ...
  String Azonosito = '';
  _ModuleStandard_8het_widget(String azonosito){Azonosito=azonosito;}
    ...
    return Scaffold(
      ...
      drawer: Drawer(
        child:   SidebarLayout(
          ...
          },                selectedWeek: '8.hét', // Specify which week is selected
          weekTextStyles: {
            '8.hét': MyTextStyles.vastagblue(context),  // Style for '1.hét'
